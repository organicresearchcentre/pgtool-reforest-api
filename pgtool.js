...
function PGTOOL() {
    ...
    function incomeCalc(_export, _price, af) {
        return (_export*_price)*(af/100)
    }

    function nincomeCalc(_export, _price, af) {
        return (_export*_price)*(1-(af/100))
    }

    function arrayCalc(exportedarray, pricearray, afarray) {
        let sum = 0
        for (let i = 0; i < exportedarray.length; i++) {
            sum += (exportedarray[i]*pricearray[i])*(afarray[i]/100)
        }
        return sum
    }

    function narrayCalc(exportedarray, pricearray, afarray) {
        let sum = 0
        for (let i = 0; i < exportedarray.length; i++) {
            sum += (exportedarray[i]*pricearray[i])*(1-(afarray[i]/100))
        }
        return sum
    }

    function arraybinaryCalc(exportedarr, pricearr, afarrbin) {
        let sum = 0
        for (let i = 0; i < exportedarr.length; i++) {
            if (afarrbin[i] == 0) {
                sum += (exportedarr[i]*pricearr[i])
            } else {
                sum += 0
            }
        }
    ...
    function narraybinaryCalc(exportedarr, pricearr, afarrbin) {
        let sum = 0
        for (let i = 0; i < exportedarr.length; i++) {
            if (afarrbin[i] == 1) {
                sum += (exportedarr[i]*pricearr[i])
    ...
    function multiplyPerc(num, perc){
        return(num*(perc/100))
    }

    function nmultiplyPerc(num, perc){
        return(num*(1-(perc/100)))
    }

    function seqCalc(val, ha, seq){
        return((val/100)*ha)*seq
    }
                ...
                indicators: {
                    initialdata_farminfo: {
                        ...
                        questions: {
                            ...
                            initialdata_farminfo_woodybiomassreplaced: {
                                question_name: "Fuel type replaced through use of wood product (i.e. select dominant type that would have been used if woodfueld unavailable)",
                                compulsory: true,
                                question_type: QUESTION_TYPE.DROPDOWN,
                                answer_list: [
                                    { answer_name: "Grid electricity", answer_code: 0 },
                                    { answer_name: "Natural gas", answer_code: 1 },
                                    { answer_name: "Heating oil", answer_code: 2 },
                                    { answer_name: "Wood pellets", answer_code: 3 },
                                    { answer_name: "Wood logs (seasoned)", answer_code: 4 },
                                    { answer_name: "Wood chips", answer_code: 5 },
                                    { answer_name: "Grasses/straw", answer_code: 6 },
                                    { answer_name: "Biogas", answer_code: 7 },
                                    { answer_name: "N/A", answer_code: 8 }
                                ]
                            },
                            initialdata_farminfo_dominantfield: {
                                question_name: "Dominant field crop system in surrounding area",
                                compulsory: true,
                                question_type: QUESTION_TYPE.DROPDOWN,
                                answer_list: [
                                    { answer_name: "Cereals", answer_code: 0 },
                                    { answer_name: "Horticulture (vegetables)", answer_code: 1 },
                                    { answer_name: "Oil Seed Rape", answer_code: 2 },
                                    { answer_name: "N/A", answer_code: 8 }
                                ]
                            },
                            initialdata_farminfo_dominantfruit: {
                                question_name: "Dominant fruit crop system in surrounding area",
                                compulsory: true,
                                question_type: QUESTION_TYPE.DROPDOWN,
                                answer_list: [
                                    { answer_name: "Apples", answer_code: 0 },
                                    { answer_name: "Pears", answer_code: 1 },
                                    { answer_name: "Olives", answer_code: 2 },
                                    { answer_name: "N/A", answer_code: 8 }
                                ]
                            }
                        }
                    ...
                    initialdata_crops: {
                            ...
                            initialdata_foragecrops: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_crops_foragecropaf',
                                        'initialdata_crops_foragecroparea',
                                        'initialdata_crops_forageincludetree'
                                    ]
                                ]
                            },
                            initialdata_permanentpasture: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_crops_permanentpastureaf',
                                        'initialdata_crops_permanentpasturearea',
                                        'initialdata_crops_permanentpastureincludetree'
                                    ]
                                ]
                            }
                        },
                        questions: {
                            ...
                            initialdata_crops_isaf: {
                                question_name: "Is in agroforestry?",
                                compulsory: true,
                                compulsoryIf: [
                                    {
                                        question: "initialdata_crops_cropname",
                            ...
                            initialdata_crops_includetree: {
                                question_name: "Do the area and yield include the tree row area?",
                                compulsory: true,
                                compulsoryIf: [
                                    {
                                        question: "initialdata_crops_cropname",
                    ...
                    initialdata_cropcosts: {
                        title: "Cropping Costs",
                        question_groups: {
                            initialdata_cropcosts: {
                            question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                rows:[
                                    'Marketing - Special channels',
                                    'Marketing - Standard channels',
                                    'Additional seed treatments',
                                    'Fuel for heating/drying/storage',
                                    'Other costs (inc. contractors and transport)',
                                    'Paid labour',
                                    'Unpaid labour',
                                    'Crop protection products',
                                    '% of crop protection products for agroforestry'
                                ],
                                columns:[
                                    'Arable crops (excl. forage)',
                                ...
                                question_codes: [
                                    [
                                        'initialdata_cropcosts_arable_special',
                                        'initialdata_cropcosts_hort_special',
                                        'initialdata_cropcosts_fruit_special',
                                        'initialdata_cropcosts_nonfood_special',
                                        'initialdata_cropcosts_forage_special'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_standard',
                                        'initialdata_cropcosts_hort_standard',
                                        'initialdata_cropcosts_fruit_standard',
                                        'initialdata_cropcosts_nonfood_standard',
                                        'initialdata_cropcosts_forage_standard'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_seedtreat',
                                        'initialdata_cropcosts_hort_seedtreat',
                                        'initialdata_cropcosts_fruit_seedtreat',
                                        'initialdata_cropcosts_nonfood_seedtreat',
                                        'initialdata_cropcosts_forage_seedtreat'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_fuel',
                                        'initialdata_cropcosts_hort_fuel',
                                        'initialdata_cropcosts_fruit_fuel',
                                        'initialdata_cropcosts_nonfood_fuel',
                                        'initialdata_cropcosts_forage_fuel'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_other',
                                        'initialdata_cropcosts_hort_other',
                                        'initialdata_cropcosts_fruit_other',
                                        'initialdata_cropcosts_nonfood_other',
                                        'initialdata_cropcosts_forage_other'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_paid',
                                        'initialdata_cropcosts_hort_paid',
                                        'initialdata_cropcosts_fruit_paid',
                                        'initialdata_cropcosts_nonfood_paid',
                                        'initialdata_cropcosts_forage_paid'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_unpaid',
                                        'initialdata_cropcosts_hort_unpaid',
                                        'initialdata_cropcosts_fruit_unpaid',
                                        'initialdata_cropcosts_nonfood_unpaid',
                                        'initialdata_cropcosts_forage_unpaid'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_protection',
                                        'initialdata_cropcosts_hort_protection',
                                        'initialdata_cropcosts_fruit_protection',
                                        'initialdata_cropcosts_nonfood_protection',
                                        'initialdata_cropcosts_forage_protection'
                                    ],
                                    [
                                        'initialdata_cropcosts_arable_afprot',
                                        'initialdata_cropcosts_hort_afprot',
                                        'initialdata_cropcosts_fruit_afprot',
                                        'initialdata_cropcosts_nonfood_afprot',
                                        'initialdata_cropcosts_forage_afprot'
                                    ],    
                                ]
                            }
                        },
                        questions: {
                            initialdata_cropcosts_arable_seedtreat: {
                                question_name: "seedtreat",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£"
                            },
                            initialdata_cropcosts_arable_paid: {
                                question_name: "paid labour",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_cropcosts_arable_afprot: {
                                question_name: "percentage of protection for agroforestry",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_cropcosts_arable_special: {
                                question_name: "Marketing - special channels",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_cropcosts_arable_standard: {
                                question_name: "Marketing - tandard channels",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_cropcosts_arable_fuel: {
                                question_name: "Fuel for heating/drying/storage",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_cropcosts_hort_afprot: {
                                question_name: "percetage of protection for agroforestry",
                                compulsory: false,
                                question_group: 'initialdata_cropcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                    ...
                    initialdata_woodland: {
                        ...
                        question_groups: {
                            initialdata_woodland: {
                                ...
                                question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                    rows: [
                                        'Agroforestry for fuel',
                                        'Agroforestry for timber',
                                        'Non-agroforestry for fuel',
                                        'Non-agroforestry for timber'
                                    ],
                                    columns: [
                                        'Area',
                                        'Tree Density',
                                        'Percentage of trees harvested this year',
                                        'On-farm use',
                                        'Exported',
                                        'Price recieved'
                                    ]
                                ...
                                question_codes: [
                                    [
                                        'initialdata_woodland_affuelarea',
                                        'initialdata_woodland_affueltreedensity',
                                        'initialdata_woodland_affuelpercharvest',
                                        'initialdata_woodland_affuelonfarm',
                                        'initialdata_woodland_affuelexported',
                                        'initialdata_woodland_affuelprice'
                                    ],
                                    [
                                        'initialdata_woodland_aftimberarea',
                                        'initialdata_woodland_aftimbertreedensity',
                                        'initialdata_woodland_aftimberpercharvest',
                                        'initialdata_woodland_aftimberonfarm',
                                        'initialdata_woodland_aftimberexported',
                                        'initialdata_woodland_aftimberprice'
                                    ],
                                    [
                                        'initialdata_woodland_nonaffuelarea',
                                        'initialdata_woodland_nonaffueltreedensity',
                                        'initialdata_woodland_nonaffuelpercharvest',
                                        'initialdata_woodland_nonaffuelonfarm',
                                        'initialdata_woodland_nonaffuelexported',
                                        'initialdata_woodland_nonaffuelprice'
                                    ],
                                    [
                                        'initialdata_woodland_nonaftimberarea',
                                        'initialdata_woodland_nonaftimbertreedensity',
                                        'initialdata_woodland_nonaftimberpercharvest',
                                        'initialdata_woodland_nonaftimberonfarm',
                                        'initialdata_woodland_nonaftimberexported',
                                        'initialdata_woodland_nonaftimberprice'
                                    ]
                                ]
                            },
                            initialdata_hedges: {
                                ...
                                question_codes: [
                                    ...
                                    [ 'initialdata_woodland_hedgefuelprice' ],
                                ]
                            }
                        },
                        questions: {
                            initialdata_woodland_affuelarea: {
                                question_name: "Agroforestry for fuel",
                                compulsory: false,
                            ...
                            initialdata_woodland_affueltreedensity: {
                                question_name: "Agroforestry for fuel - tree density",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                                        question: "initialdata_woodland_affuelarea",
                            ...
                            initialdata_woodland_affuelpercharvest: {
                                question_name: "Agroforestry for fuel - Percentage of tree harvest this year",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_affuelonfarm: {
                                question_name: "Agroforestry for fuel - on farm use",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_affuelexported: {
                                question_name: "Agroforestry for fuel - exported",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_affuelprice: {
                                question_name: "Agroforestry for fuel - price",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_aftimberarea: {
                                question_name: "Agroforestry for timber",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_woodland_aftimbertreedensity: {
                                question_name: "Agroforestry for timber - tree density",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                                        question: "initialdata_woodland_aftimberarea",
                                        evaluate: EVALUATORS.GREATER_THAN,
                                        value: 0
                                    }
                                ],
                            ...
                            initialdata_woodland_aftimberpercharvest: {
                                question_name: "Agroforestry for timber - Percentage of tree harvest this year",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_aftimberonfarm: {
                                question_name: "Agroforestry for timber - on farm use",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_aftimberexported: {
                                question_name: "Agroforestry for timber - exported",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_aftimberprice: {
                                question_name: "Agroforestry for timber - price",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaffuelarea: {
                                question_name: "Non-sgroforestry for fuel",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_woodland_nonaffueltreedensity: {
                                question_name: "Non-agroforestry for fuel - tree density",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                                        question: "initialdata_woodland_nonaffuelarea",
                                        evaluate: EVALUATORS.GREATER_THAN,
                                        value: 0
                                    }
                                ],
                            ...
                            initialdata_woodland_nonaffuelpercharvest: {
                                question_name: "Non-agroforestry for fuel - Percentage of tree harvest this year",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaffuelonfarm: {
                                question_name: "Non-agroforestry for fuel - on farm use",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaffuelexported: {
                                question_name: "Non-agroforestry for fuel - exported",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaffuelprice: {
                                question_name: "Non-agroforestry for fuel - price",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaftimberarea: {
                                question_name: "Non-agroforestry for timber",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_woodland_nonaftimbertreedensity: {
                                question_name: "Non-agroforestry for timber - tree density",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                                        question: "initialdata_woodland_nonaftimberarea",
                                        evaluate: EVALUATORS.GREATER_THAN,
                                        value: 0
                                    }
                                ],
                            ...
                            initialdata_woodland_nonaftimberpercharvest: {
                                question_name: "Non-agroforestry for timber - Percentage of tree harvest this year",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaftimberonfarm: {
                                question_name: "Non-agroforestry for timber - on farm use",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaftimberexported: {
                                question_name: "Non-agroforestry for timber - exported",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                            ...
                            initialdata_woodland_nonaftimberprice: {
                                question_name: "Non-agroforestry for timber - price",
                                compulsory: false,
                                question_group: 'initialdata_woodland',
                                compulsoryIf: [
                                    {
                    ...
                    initialdata_landuse: {
                        ...
                        questions: {
                            ...
                            initialdata_landuse_totalwoodland: {
                                ...
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_unit: "ha",
                                precedents: [ 'initialdata_woodland_affuelarea', 'initialdata_woodland_aftimberarea', 'initialdata_woodland_nonaffuelarea', 'initialdata_woodland_nonaftimberarea' ]
                    ...
                    initialdata_seedsfeeds: {
                            ...
                            initialdata_seeds: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_seedsfeeds_seedsexportaf'
                                    ]
                                ]
                            },
                            initialdata_feeds: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_seedsfeeds_feedsexportaf',
                            ...
                            initialdata_arablestraw: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_seedsfeeds_arablestrawimportprice',
                                        'initialdata_seedsfeeds_arablestrawexport',
                                        'initialdata_seedsfeeds_arablestrawexportaf',
                                        'initialdata_seedsfeeds_arablestrawexportprice'
                                    ]
                                ]
                            },
                        },
                        questions: {
                            ...
                            initialdata_seedsfeeds_seedsexportaf: {
                                question_name: "Percentage of Exported Seeds grown in agroforestry",
                                compulsory: true,
                                compulsoryIf: [
                                    {
                                        question: "initialdata_seedsfeeds_seedstype",
                            ...
                            initialdata_seedsfeeds_feedsexportaf: {
                                question_name: "Percentage of exported feeds grown in agroforestry",
                                compulsory: true,
                                compulsoryIf: [
                                    {
                                        question: "initialdata_seedsfeeds_feedstype",
                            ...
                            initialdata_seedsfeeds_arablestrawimportprice: {
                                question_name: "Arable straw - Import price",
                                compulsory: false,
                                question_group: 'initialdata_arablestraw',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_unit: "£/t"
                            ...
                            initialdata_seedsfeeds_arablestrawexportaf: {
                                question_name: "Percentage of Arable Straw grown under Agroforestry",
                                compulsory: false,
                                question_group: 'initialdata_arablestraw',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_unit: "%"
                    ...
                    initialdata_fertilisers: {
                            ...
                            initialdata_organicfertilisers: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_fertilisers_organicimportaf',
                            ...
                            initialdata_inorganicfertilisers: {
                                ...
                                question_codes: [
                                    [
                                        ...
                                        'initialdata_fertilisers_inorganicimportaf',
                        ...
                        questions: {
                            ...
                            initialdata_fertilisers_organicimportaf: {
                                question_name: "Percentage of Import for Agroforestry System",
                                compulsory: true,
                                compulsoryIf: [
                                    {
                                        question: "initialdata_fertilisers_organictype",
                    ...
                    initialdata_livestock: {
                        ...
                        questions: {
                            ...
                            initialdata_livestock_percaf: {
                                question_name: "Percentage of Time Spent in Agroforestry",
                                guidance: {
                                    html: false,
                                    content: "This is the percentage of time these animals spend within the agroforestry system for the 12 month period."
                                },
                                compulsory: true,
                                compulsoryIf: [
                                    {
                    ...
                    initialdata_livestockcosts: {
                        title: "Livestock Costs",
                        question_groups: {
                            initialdata_livestockcosts: {
                            question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                rows:[
                                ...
                                question_codes: [
                                    [
                                        'initialdata_livestockcosts_dairy_special',
                                        'initialdata_livestockcosts_beef_special',
                                        'initialdata_livestockcosts_sheep_special',
                                        'initialdata_livestockcosts_pigs_special',
                                        'initialdata_livestockcosts_chickens_special',
                                        'initialdata_livestockcosts_turkey_special',
                                        'initialdata_livestockcosts_ducks_special',
                                        'initialdata_livestockcosts_horses_special',
                                        'initialdata_livestockcosts_other_special'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_standard',
                                        'initialdata_livestockcosts_beef_standard',
                                        'initialdata_livestockcosts_sheep_standard',
                                        'initialdata_livestockcosts_pigs_standard',
                                        'initialdata_livestockcosts_chickens_standard',
                                        'initialdata_livestockcosts_turkey_standard',
                                        'initialdata_livestockcosts_ducks_standard',
                                        'initialdata_livestockcosts_horses_standard',
                                        'initialdata_livestockcosts_other_standard'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_vet',
                                        'initialdata_livestockcosts_beef_vet',
                                        'initialdata_livestockcosts_sheep_vet',
                                        'initialdata_livestockcosts_pigs_vet',
                                        'initialdata_livestockcosts_chickens_vet',
                                        'initialdata_livestockcosts_turkey_vet',
                                        'initialdata_livestockcosts_ducks_vet',
                                        'initialdata_livestockcosts_horses_vet',
                                        'initialdata_livestockcosts_other_vet'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_bedding',
                                        'initialdata_livestockcosts_beef_bedding',
                                        'initialdata_livestockcosts_sheep_bedding',
                                        'initialdata_livestockcosts_pigs_bedding',
                                        'initialdata_livestockcosts_chickens_bedding',
                                        'initialdata_livestockcosts_turkey_bedding',
                                        'initialdata_livestockcosts_ducks_bedding',
                                        'initialdata_livestockcosts_horses_bedding',
                                        'initialdata_livestockcosts_other_bedding'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_other',
                                        'initialdata_livestockcosts_beef_other',
                                        'initialdata_livestockcosts_sheep_other',
                                        'initialdata_livestockcosts_pigs_other',
                                        'initialdata_livestockcosts_chickens_other',
                                        'initialdata_livestockcosts_turkey_other',
                                        'initialdata_livestockcosts_ducks_other',
                                        'initialdata_livestockcosts_horses_other',
                                        'initialdata_livestockcosts_other_other'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_paid',
                                        'initialdata_livestockcosts_beef_paid',
                                        'initialdata_livestockcosts_sheep_paid',
                                        'initialdata_livestockcosts_pigs_paid',
                                        'initialdata_livestockcosts_chickens_paid',
                                        'initialdata_livestockcosts_turkey_paid',
                                        'initialdata_livestockcosts_ducks_paid',
                                        'initialdata_livestockcosts_horses_paid',
                                        'initialdata_livestockcosts_other_paid'
                                    ],
                                    [
                                        'initialdata_livestockcosts_dairy_unpaid',
                                        'initialdata_livestockcosts_beef_unpaid',
                                        'initialdata_livestockcosts_sheep_unpaid',
                                        'initialdata_livestockcosts_pigs_unpaid',
                                        'initialdata_livestockcosts_chickens_unpaid',
                                        'initialdata_livestockcosts_turkey_unpaid',
                                        'initialdata_livestockcosts_ducks_unpaid',
                                        'initialdata_livestockcosts_horses_unpaid',
                                        'initialdata_livestockcosts_other_unpaid'
                                    ]   
                                ]
                            }
                        },
                        questions: {
                            initialdata_livestockcosts_dairy_vet: {
                                question_name: "seedtreat",
                                compulsory: false,
                                question_group: 'initialdata_livestockcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£"
                            },
                    ...
                    initialdata_treecosts: {
                        ...
                        question_groups: {
                            ...
                            question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                rows:[
                                    'Pruning',
                                    'Purchased fertiliser and crop protection',
                                ...
                                columns:[
                                    'Agroforestry Fruit/Nut Trees',
                                    'Agroforestry Fuel/Woodchip Trees',
                                    'Agroforestry Timber',
                                    'Non-agroforestry Fruit/Nut Trees',
                                    'Non-agroforestry Fuel/Woodchip Trees',
                                    'Non-agroforestry Timber',
                                ],
                            },
                                question_codes: [
                                    [
                                        'initialdata_treecosts_affn_pruning',
                                        'initialdata_treecosts_affw_pruning',
                                        'initialdata_treecosts_aft_pruning',
                                        'initialdata_treecosts_naffn_pruning',
                                        'initialdata_treecosts_naffw_pruning',
                                        'initialdata_treecosts_naft_pruning'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_fert',
                                        'initialdata_treecosts_affw_fert',
                                        'initialdata_treecosts_aft_fert',
                                        'initialdata_treecosts_naffn_fert',
                                        'initialdata_treecosts_naffw_fert',
                                        'initialdata_treecosts_naft_fert'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_understory',
                                        'initialdata_treecosts_affw_understory',
                                        'initialdata_treecosts_aft_understory',
                                        'initialdata_treecosts_naffn_understory',
                                        'initialdata_treecosts_naffw_understory',
                                        'initialdata_treecosts_naft_understory'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_harvesting',
                                        'initialdata_treecosts_affw_harvesting',
                                        'initialdata_treecosts_aft_harvesting',
                                        'initialdata_treecosts_naffn_harvesting',
                                        'initialdata_treecosts_naffw_harvesting',
                                        'initialdata_treecosts_naft_harvesting'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_grading',
                                        'initialdata_treecosts_affw_grading',
                                        'initialdata_treecosts_aft_grading',
                                        'initialdata_treecosts_naffn_grading',
                                        'initialdata_treecosts_naffw_grading',
                                        'initialdata_treecosts_naft_grading'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_packaging',
                                        'initialdata_treecosts_affw_packaging',
                                        'initialdata_treecosts_aft_packaging',
                                        'initialdata_treecosts_naffn_packaging',
                                        'initialdata_treecosts_naffw_packaging',
                                        'initialdata_treecosts_naft_packaging'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_special',
                                        'initialdata_treecosts_affw_special',
                                        'initialdata_treecosts_aft_special',
                                        'initialdata_treecosts_naffn_special',
                                        'initialdata_treecosts_naffw_special',
                                        'initialdata_treecosts_naft_special'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_standard',
                                        'initialdata_treecosts_affw_standard',
                                        'initialdata_treecosts_aft_standard',
                                        'initialdata_treecosts_naffn_standard',
                                        'initialdata_treecosts_naffw_standard',
                                        'initialdata_treecosts_naft_standard'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_fuel',
                                        'initialdata_treecosts_affw_fuel',
                                        'initialdata_treecosts_aft_fuel',
                                        'initialdata_treecosts_naffn_fuel',
                                        'initialdata_treecosts_naffw_fuel',
                                        'initialdata_treecosts_naft_fuel'
                                    ],
                                    [
                                        'initialdata_treecosts_affn_other',
                                        'initialdata_treecosts_affw_other',
                                        'initialdata_treecosts_aft_other',
                                        'initialdata_treecosts_naffn_other',
                                        'initialdata_treecosts_naffw_other',
                                        'initialdata_treecosts_naft_other',
                                    ],
                                    [
                                        'initialdata_treecosts_affn_unpaid',
                                        'initialdata_treecosts_affw_unpaid',
                                        'initialdata_treecosts_aft_unpaid',
                                        'initialdata_treecosts_naffn_unpaid',
                                        'initialdata_treecosts_naffw_unpaid',
                                        'initialdata_treecosts_naft_unpaid'
                                    ]
                                ]
                            }
                        },
                        questions: {
                            initialdata_treecosts_affn_pruning: {
                                question_name: "Pruning",
                                compulsory: false,
                                question_group: 'initialdata_treecosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£"
                            },
                            initialdata_treecosts_affn_fert: {
                                question_name: "Fertiliser & crop protection",
                                compulsory: false,
                                question_group: 'initialdata_treecosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treecosts_affn_understory: {
                                question_name: "Understory management",
                                compulsory: false,
                                question_group: 'initialdata_treecosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                    ...
                    initialdata_treeestcosts: {
                        title: "Tree Establishment Costs (most recent phase of planting)",
                        question_groups: {
                            initialdata_treeestcosts: {
                            question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                rows:[
                                    ...
                                    'Planting area (including intercropped area)',
                                    'Cost of tree',
                                    'Tree protection',
                                    'Fencing',
                                    'Land preperation',
                                ...
                                question_codes: [
                                    [
                                        'initialdata_treeestcosts_fn_year',
                                        'initialdata_treeestcosts_fw_year',
                                        'initialdata_treeestcosts_t_year'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_numb',
                                        'initialdata_treeestcosts_fw_numb',
                                        'initialdata_treeestcosts_t_numb'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_area',
                                        'initialdata_treeestcosts_fw_area',
                                        'initialdata_treeestcosts_t_area'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_tree',
                                        'initialdata_treeestcosts_fw_tree',
                                        'initialdata_treeestcosts_t_tree'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_protection',
                                        'initialdata_treeestcosts_fw_protection',
                                        'initialdata_treeestcosts_t_protection'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_fencing',
                                        'initialdata_treeestcosts_fw_fencing',
                                        'initialdata_treeestcosts_t_fencing'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_prep',
                                        'initialdata_treeestcosts_fw_prep',
                                        'initialdata_treeestcosts_t_prep'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_fert',
                                        'initialdata_treeestcosts_fw_fert',
                                        'initialdata_treeestcosts_t_fert'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_planting',
                                        'initialdata_treeestcosts_fw_planting',
                                        'initialdata_treeestcosts_t_planting'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_irrigation',
                                        'initialdata_treeestcosts_fw_irrigation',
                                        'initialdata_treeestcosts_t_irrigation'
                                    ],
                                    [
                                        'initialdata_treeestcosts_fn_replacement',
                                        'initialdata_treeestcosts_fw_replacement',
                                        'initialdata_treeestcosts_t_replacement'
                                    ],
                                ]
                            }
                        },
                        questions: {
                            initialdata_treeestcosts_fn_year: {
                                question_name: "Year of Purchase",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: ""
                            },
                            initialdata_treeestcosts_fn_numb: {
                                question_name: "Number of Trees Planted",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_area: {
                                question_name: "Planting area (including intercropped)",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_protection: {
                                question_name: "Cost of Protection",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_prep: {
                                question_name: "Cost of Land Preperation",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_fert: {
                                question_name: "Cost of Fertiliser and Herbicide",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_planting: {
                                question_name: "Cost of planting",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_irrigation: {
                                question_name: "Cost of Irrigation",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            initialdata_treeestcosts_fn_replacement: {
                                question_name: "Cost of Replacement Trees",
                                compulsory: false,
                                question_group: 'initialdata_treeestcosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
            ...
            soilmanagement: {
                ...
                indicators: {
                    ...
                    soilmanagement_erosion: {
                        title: "Soil erosion",
                        questions: {
                            soilmanagement_erosion_perceffect: {
                        ...
                        question_groups: {
                            energycarbon_carbonstocksgroup: {
                                ...
                                question_group_headers: {
                                    ...
                                    rows: [
                                        'Total land under arable or temporary grassland',
                                        '- of which % crop residues left on soil surface?',
                                        '- of which % use of cover/catch crops?',
                                        '- of which % under nitrogen-fixers e.g. legumes?',
                                        'Total land under permanent grassland',
                                        'Total timber or SRC agroforestry',
                                        'Total fruit/nut agroforestry',
                                        'Total area of established woodland (>50 years old)',
                                        '- of which % managed .e.g. thinning, coppicing',
                                        'Total woodland planting in past 50 years'
                                    ]
                                },
                                question_codes: [
                                    [ 'energycarbon_carbonstocks_underarable','energycarbon_carbonstocks_underarableseq' ],
                                    [ 'energycarbon_carbonstocks_residue', 'energycarbon_carbonstocks_residueseq' ],
                                    [ 'energycarbon_carbonstocks_cover', 'energycarbon_carbonstocks_coverseq' ],
                                    [ 'energycarbon_carbonstocks_nitrogen', 'energycarbon_carbonstocks_nitrogenseq' ],
                                    [ 'energycarbon_carbonstocks_permanent', 'energycarbon_carbonstocks_permanentseq' ],
                                    [ 'energycarbon_carbonstocks_timber', 'energycarbon_carbonstocks_timberseq' ],
                                    [ 'energycarbon_carbonstocks_fruit', 'energycarbon_carbonstocks_fruitseq' ],
                                    [ 'energycarbon_carbonstocks_woodland50', 'energycarbon_carbonstocks_woodland50seq' ],
                                    [ 'energycarbon_carbonstocks_managed', 'energycarbon_carbonstocks_managedseq' ],
                                    [ 'energycarbon_carbonstocks_woodland49', 'energycarbon_carbonstocks_woodland49seq' ],
                                ]
                            },
                            energycarbon_carbonstocks_total: {
                                question_group_type: QUESTION_GROUP_TYPE.TABLE,
                                question_group_headers: {
                                    columns: [ 
                                        '',
                                    ...
                                    rows: [
                                        'Total carbon sequestered and avoided loss per year',
                                        'Total carbon sequestered and avoided loss per ha per year'
                                    ]
                                },
                                question_codes: [
                                    [ 'energycarbon_carbonstocks_total'],
                                    ['energycarbon_carbonstocks_totalperha']
                                ]
                            }
                        },
                        questions: {
                            energycarbon_carbonstocks_underarable: {
                            ...
                            energycarbon_carbonstocks_underarableseq: {
                            ...
                            energycarbon_carbonstocks_residue: {
                            ...
                            energycarbon_carbonstocks_cover: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_nitrogen: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_permanent: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_permanentseq: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_timber: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_timberseq: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_fruit: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_woodland50: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_managed: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_woodland49: {
                                question_name: 'Total land under arable or temporary grassland',
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocksgroup',
                            ...
                            energycarbon_carbonstocks_total: {
                                ...
                                compulsory: false,
                                question_type: QUESTION_TYPE.NUMBER,
                                question_group: 'energycarbon_carbonstocks_total',
                                auto_calc: true,
                                answer_unit: "tCO2e",
                            },
                            energycarbon_carbonstocks_totalperha:{
                ...
                indicators: {
                    socialcapital_employment: {
                            ...
                            socialcapital_employmentgroup: {
                                ...
                                question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                    rows: [
                                        ...
                                        'Unpaid farmer labour'
                                    ],
                                    columns: [
                                        'Time',
                                        '% time spent on tree enteprise',
                                        '% time spent on non-tree enteprise',
                                    ]
                                },
                                question_codes: [
                                    [   
                                        'socialcapital_employment_casual',
                                        'socialcapital_employment_casual_tree',
                                        'socialcapital_employment_casual_ntree'
                                    ],
                                    [
                                        'socialcapital_employment_longterm',
                                        'socialcapital_employment_longterm_tree',
                                        'socialcapital_employment_longterm_ntree'
                                    ],
                                    [
                                        'socialcapital_employment_familylabour',
                                        'socialcapital_employment_familylabour_tree',
                                        'socialcapital_employment_familylabour_ntree'
                                    ]
                        ...
                        questions: {
                            ...
                            socialcapital_employment_casual_tree: {
                                question_name: "How much paid time is spent in the tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            socialcapital_employment_longterm_tree: {
                                question_name: "How much unpaid voluntary time is spent in the tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            socialcapital_employment_familylabour_tree: {
                                question_name: "How many unpaid family time is spent in the tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            socialcapital_employment_casual_ntree: {
                                question_name: "How much paid time is spent in the non-tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            socialcapital_employment_longterm_ntree: {
                                question_name: "How much unpaid voluntary time is spent in the non-tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                            ...
                            socialcapital_employment_familylabour_ntree: {
                                question_name: "How many unpaid family time is spent in the non-tree enteprise?",
                                compulsory: false,
                                question_group: 'socialcapital_employmentgroup',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                    ...
                    socialcapital_employmentother:{
                        title: "Employment other",
                        questions: {
                            socialcapital_employmentother_salary:{                            
                            ...
                            socialcapital_employmentother_otherbusiness:{
                ...
                indicators: {
                    farmbusinessresilience_farmincome: {
                        ...
                        question_groups: {
                            farmbusinessresilience_farmincome: {
                                question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                    rows: [
                                        'Decoupled payments',
                                        'Agricultural practices for climate and environment',
                                        'Coupled payments',
                                        'Rural development payments',
                                        'Other payments and support',
                                        'Income from grants',
                                        'Income from other agricultural enteprises',
                                        'Income from other non-agricultural enteprises'
                                    ],
                                    columns: [
                                        'Agroforestry',
                                        'Non-agroforestry',
                                ...
                                question_codes: [
                                    [   
                                        'farmbusinessresilience_farmincome_decoupled_af',
                                        'farmbusinessresilience_farmincome_decoupled_naf',
                                        'farmbusinessresilience_farmincome_decoupled_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_agprac_af',
                                        'farmbusinessresilience_farmincome_agprac_naf',
                                        'farmbusinessresilience_farmincome_agprac_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_coupled_af',
                                        'farmbusinessresilience_farmincome_coupled_naf',
                                        'farmbusinessresilience_farmincome_coupled_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_ruraldev_af',
                                        'farmbusinessresilience_farmincome_ruraldev_naf',
                                        'farmbusinessresilience_farmincome_ruraldev_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_other_af',
                                        'farmbusinessresilience_farmincome_other_naf',
                                        'farmbusinessresilience_farmincome_other_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_grants_af',
                                        'farmbusinessresilience_farmincome_grants_naf',
                                        'farmbusinessresilience_farmincome_grants_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_otherag_af',
                                        'farmbusinessresilience_farmincome_otherag_naf',
                                        'farmbusinessresilience_farmincome_otherag_total'
                                    ],
                                    [
                                        'farmbusinessresilience_farmincome_othernag_af',
                                        'farmbusinessresilience_farmincome_othernag_naf',
                                        'farmbusinessresilience_farmincome_othernag_total'
                                    ]
                        ...
                        questions: {
                            farmbusinessresilience_farmincome_decoupled_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£"
                            },
                            ...
                            farmbusinessresilience_farmincome_decoupled_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_decoupled_af', 'farmbusinessresilience_farmincome_decoupled_naf']
                            },
                            farmbusinessresilience_farmincome_agprac_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_agprac_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_agprac_af', 'farmbusinessresilience_farmincome_agprac_naf']
                            },
                            farmbusinessresilience_farmincome_coupled_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_coupled_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_coupled_af', 'farmbusinessresilience_farmincome_coupled_naf']
                            },
                            farmbusinessresilience_farmincome_ruraldev_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_ruraldev_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_ruraldev_af', 'farmbusinessresilience_farmincome_ruraldev_naf']
                            },
                            farmbusinessresilience_farmincome_other_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_other_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_other_af', 'farmbusinessresilience_farmincome_other_naf']
                            },
                            farmbusinessresilience_farmincome_grants_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_grants_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_grants_af', 'farmbusinessresilience_farmincome_grants_naf']
                            },
                            farmbusinessresilience_farmincome_otherag_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_otherag_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_otherag_af', 'farmbusinessresilience_farmincome_otherag_naf']
                            },
                            farmbusinessresilience_farmincome_othernag_af: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_farmincome',
                            ...
                            farmbusinessresilience_farmincome_othernag_total: {
                                ...
                                answer_unit: "£",
                                auto_calc: true,
                                precedents: ['farmbusinessresilience_farmincome_othernag_af', 'farmbusinessresilience_farmincome_othernag_naf']
                            }
                        }
                    },
                    farmbusinessresilience_othercosts:{
                        title: 'Other costs',
                        question_groups:{
                        farmbusinessresilience_othercosts: {
                            heading: {
                                    html: false,
                                    content: "Fixed costs, assets, and liabilities"
                                },
                                question_group_type: QUESTION_GROUP_TYPE.TABLE_HEADERS_LEFT,
                                question_group_headers: {
                                    rows: [
                                        'Upkeep of machinery and equipment',
                                        'Specific costs',
                                        'Farming overheads',
                                        'Rent paid',
                                        'Depreciation',
                                ...
                                question_codes: [
                                    [ 'farmbusinessresilience_othercosts_upkeep' ],
                                    [ 'farmbusinessresilience_othercosts_specific' ],
                                    [ 'farmbusinessresilience_othercosts_overheads' ],
                                    [ 'farmbusinessresilience_othercosts_rent' ],
                                    [ 'farmbusinessresilience_othercosts_depreciation' ],
                                    [ 'farmbusinessresilience_othercosts_assets' ],
                                    [ 'farmbusinessresilience_othercosts_liabilities' ]
                                ]
                            }
                        },
                        questions: {
                            farmbusinessresilience_othercosts_upkeep: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_othercosts',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£",
                            },
                    ...
                    farmbusinessresilience_financialsum: {
                        ...
                        question_groups: {
                            farmbusinessresilience_financialsum: {
                                ...
                                question_codes: [
                                    [   
                                        'farmbusinessresilience_financialsum_income_afc',
                                        'farmbusinessresilience_financialsum_income_nafc',
                                        'farmbusinessresilience_financialsum_income_livestock',
                                        'farmbusinessresilience_financialsum_income_other'
                                    ],
                                    [ 
                                        'farmbusinessresilience_financialsum_variable_afc',
                                        'farmbusinessresilience_financialsum_variable_nafc',
                                        'farmbusinessresilience_financialsum_variable_livestock',
                                        'farmbusinessresilience_financialsum_variable_other'
                                    ],
                                    [ 
                                        'farmbusinessresilience_financialsum_gross_afc',
                                        'farmbusinessresilience_financialsum_gross_nafc',
                                        'farmbusinessresilience_financialsum_gross_livestock',
                                        'farmbusinessresilience_financialsum_gross_other'
                                    ]
                                ]
                            },
                            farmbusinessresilience_financialsum_fixed: {
                                question_group_type: QUESTION_GROUP_TYPE.TABLE,question_group_headers: {
                                    rows: [
                                        'Fixed costs'
                                    ],
                                ...
                                question_codes: [
                                    [ 
                                        'farmbusinessresilience_financialsum_fixed_total'
                                    ]
                        ...
                        questions: {
                            farmbusinessresilience_financialsum_income_afc: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_financialsum',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£",
                                auto_calc: true
                            ...
                            farmbusinessresilience_financialsum_fixed_total: {
                                compulsory: false,
                                question_group: 'farmbusinessresilience_financialsum_fixed',
                                question_type: QUESTION_TYPE.NUMBER,
                                answer_limits: { min: 0 },
                                answer_unit: "£",
                                auto_calc: true,
                        ...
                        questions:{
                            governance_ethics_decisions: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "Have considered it in 1-2 areas", answer_code: 2 },
                                    { answer_name: "Given it no consideration except where legally required", answer_code: 3 },
                                    { answer_name: "Given it no consideration at all", answer_code: 4 }
                                ]
                            },
                            governance_ethics_permaculture: {
                                ...
                                answer_list: [
                                    { answer_name: "All the principles met effectively", answer_code: 0 },
                                    { answer_name: "2 out of 3 principles met effectively", answer_code: 1 },
                                    { answer_name: "1 out of 3 principles met effectively", answer_code: 2 },
                                    { answer_name: "None of the pemaculture principles are met", answer_code: 3 },
                                    { answer_name: "N/A", answer_code: 4 }
                                ]
                            }
                        }
                        ...
                        questions:{
                            governance_accountability_tool: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "Assessment conducted but only once. No plans to repeat.", answer_code: 2 },
                                    { answer_name: "No assessment ever conducted", answer_code: 3 }
                                ]
                            },
                            governance_accountability_managementplan: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "Have basic plans in palce across 1+ dimensions", answer_code: 2 },
                                    { answer_name: "Have considered sustianability management but no formal plans are in place", answer_code: 3 },
                                    { answer_name: "Have not considered/implemented plans in this area", answer_code: 4 }
                                ]
                            }
                        }
                    },
                        ...
                        questions:{
                            governance_law_compliance: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "Law has been accidentally broken in the last 5 years but farm is now compliant", answer_code: 2 },
                                    { answer_name: "Current practices do not meet all legal requirements", answer_code: 3 }
                                ]
                            },
                            governance_law_access: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "Yes, considered working towards compliance with requirements", answer_code: 2 },
                                    { answer_name: "Previous tenants land access not considered in acquisition", answer_code: 3 },
                                    { answer_name: "N/A", answer_code: 4 }
                                ]
                            }
                        }
                        ...
                        questions:{
                            governance_holistic_changes: {
                                ...
                                answer_list: [
                                    ...
                                    { answer_name: "No changes to practices", answer_code: 2 },
                                    { answer_name: "N/A", answer_code: 3 }
                                ]
                            }
                        }
            ...
            soilmanagement: {
                ...
                indicators: {
                    ...
                    soilmanagement_erosion: {
                        total: indicatorTotalFn,
                        questions: {
                            soilmanagement_erosion_perceffect: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 1,
                                    1: 2,
            ...
            energycarbon: {
                ...
                indicators: {
                    ...
                    energycarbon_carbonstocks: {
                        total: indicatorTotalFn,
                        questions: {
                            energycarbon_carbonstocks_totalperha: function(){
                                var avalue = get('energycarbon_carbonstocks_totalperha')
                                if (avalue < 0.1) {
                                    return 1
                                } else if (avalue >= 0.1 && avalue < 1) {
                                    return 2
                                } else if (avalue >= 1 && avalue < 3) {
                                    return 3
                                } else if (avalue >= 3 && avalue < 5) {
                                    return 4
                                } else if (avalue >= 5) {
                                    return 5
                                } else
            ...
            socialcapital: {
                ...
                indicators: {
                    ...
                    socialcapital_employmentother: {
                        total: indicatorTotalFn,
                        questions: {
                            socialcapital_employmentother_salary: function(acode) {
                                var scores = {
                                    0: 1,
                                    1: 3,
                                    2: 5,
                            ...
                            socialcapital_employmentother_otherbusiness: function(acode) {
                               var scores = {
                                    0: 1,
                                    1: 3,
                                    2: 5
            ...
            governance: {
                ...
                indicators: {
                    governance_ethics: {
                        total: indicatorTotalFn,
                        questions: {
                            governance_ethics_decisions: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                            ...
                            governance_ethics_permaculture: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                    ...
                    governance_accountability: {
                        total: indicatorTotalFn,
                        questions: {
                            governance_accountability_tool: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                            ...
                            governance_accountability_managementplan: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                    ...
                    governance_participation: {
                        total: indicatorTotalFn,
                        questions: {
                            governance_participation_collaboration: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                    ...
                    governance_law: {
                        total: indicatorTotalFn,
                        questions: {
                            governance_law_compliance: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 4,
                            ...
                            governance_law_access: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 3,
                    ...
                    governance_holistic: {
                        total: indicatorTotalFn,
                        questions: {
                            governance_holistic_changes: function(acode) {
                                if (acode === false) return false
                                var scores = {
                                    0: 5,
                                    1: 3,
                    ...
                    initialdata_landuse: {
                        ...
                        questions: {
                            ...
                            initialdata_landuse_totalwoodland: function() {
                                return get('initialdata_woodland_affuelarea')+
                                get('initialdata_woodland_aftimberarea')+
                                get('initialdata_woodland_nonaffuelarea')+
                                get('initialdata_woodland_nonaftimberarea')
            ...
            energycarbon: {
                ...
                indicators: {
                    ...
                    energycarbon_carbonstocks: {
                        aggregator: indicatorAggregatorFn,
                        questions: {
                            energycarbon_carbonstocks_underarable: function() {
                                return get('initialdata_landuse_totalarablearea')
                            },
                            energycarbon_carbonstocks_underarableseq: function(){
                                return get('energycarbon_carbonstocks_underarable')*0
                            },
                            energycarbon_carbonstocks_residueseq: function() {
                                return seqCalc(get('energycarbon_carbonstocks_residue'), get('energycarbon_carbonstocks_underarable'), 1.155)
                            },
                            energycarbon_carbonstocks_coverseq: function() {
                                return seqCalc(get('energycarbon_carbonstocks_cover'), get('energycarbon_carbonstocks_underarable'), 1.175)
                            },
                            energycarbon_carbonstocks_nitrogenseq: function() {
                                return seqCalc(get('energycarbon_carbonstocks_nitrogen'), get('energycarbon_carbonstocks_underarable'), 0.024)
                            },
                            energycarbon_carbonstocks_permanent: function() {
                                return get('initialdata_landuse_totalgrassarea')
                            },
                            energycarbon_carbonstocks_permanentseq: function(){
                                return get('energycarbon_carbonstocks_permanent')*4.75
                            },
                            energycarbon_carbonstocks_timber: function() {
                                return get('initialdata_woodland_affuelarea')
                            },
                            energycarbon_carbonstocks_timberseq: function(){
                                return get('energycarbon_carbonstocks_timber')*7.015
                            },
                            energycarbon_carbonstocks_fruitseq: function(){
                                return get('energycarbon_carbonstocks_fruit')*0.845
                            },
                            energycarbon_carbonstocks_woodland50seq: function(){
                                return get('energycarbon_carbonstocks_woodland50')*4.015
                            },
                            energycarbon_carbonstocks_managedseq: function() {
                                return seqCalc(get('energycarbon_carbonstocks_managed'), get('energycarbon_carbonstocks_woodland50'), 5.63)
                            },
                            energycarbon_carbonstocks_woodland49seq: function(){
                                return get('energycarbon_carbonstocks_woodland49')*6.91
                            },
                            energycarbon_carbonstocks_total: function() {
                                return get('energycarbon_carbonstocks_underarableseq')+
                                get('energycarbon_carbonstocks_residueseq')+
                                get('energycarbon_carbonstocks_coverseq')+
                                get('energycarbon_carbonstocks_nitrogenseq')+
                                get('energycarbon_carbonstocks_permanentseq')+
                                get('energycarbon_carbonstocks_timberseq')+
                                get('energycarbon_carbonstocks_fruitseq')+
                                get('energycarbon_carbonstocks_woodland50seq')+
                                get('energycarbon_carbonstocks_managedseq')+
                                get('energycarbon_carbonstocks_woodland49seq')
                            },
                            energycarbon_carbonstocks_totalperha: function() {
                                return get('energycarbon_carbonstocks_total')/(get('initialdata_landuse_totalarablearea')+get('initialdata_landuse_totalgrassarea')+get('initialdata_landuse_totalwoodland'))
                            }
                        }
                    }
                }
            ...
            farmbusinessresilience: {
                ...
                indicators: {
                    farmbusinessresilience_farmincome: {
                        aggregator: indicatorAggregatorFn,
                        questions: {
                            farmbusinessresilience_farmincome_decoupled_total: function() {
                                return get('farmbusinessresilience_farmincome_decoupled_af')+ get('farmbusinessresilience_farmincome_decoupled_naf')
                            },
                            farmbusinessresilience_farmincome_agprac_total: function() {
                                return get('farmbusinessresilience_farmincome_agprac_af')+ get('farmbusinessresilience_farmincome_agprac_naf')
                            },
                            farmbusinessresilience_farmincome_coupled_total: function() {
                                return get('farmbusinessresilience_farmincome_coupled_af')+ get('farmbusinessresilience_farmincome_coupled_naf')
                            },
                            farmbusinessresilience_farmincome_ruraldev_total: function() {
                                return get('farmbusinessresilience_farmincome_ruraldev_af')+ get('farmbusinessresilience_farmincome_ruraldev_naf')
                            },
                            farmbusinessresilience_farmincome_other_total: function() {
                                return get('farmbusinessresilience_farmincome_other_af')+ get('farmbusinessresilience_farmincome_other_naf')
                            },
                            farmbusinessresilience_farmincome_grants_total: function() {
                                return get('farmbusinessresilience_farmincome_grants_af')+ get('farmbusinessresilience_farmincome_grants_naf')
                            },
                            farmbusinessresilience_farmincome_otherag_total: function() {
                                return get('farmbusinessresilience_farmincome_otherag_af')+ get('farmbusinessresilience_farmincome_otherag_naf')
                            },
                            farmbusinessresilience_farmincome_othernag_total: function() {
                                return get('farmbusinessresilience_farmincome_othernag_af')+ get('farmbusinessresilience_farmincome_othernag_naf')
                            }
                        }
                    },
                    farmbusinessresilience_financialsum: {
                        ...
                        questions: {
                            farmbusinessresilience_financialsum_income_afc: function() {
                                ...
                                get('farmbusinessresilience_farmincome_grants_af')+
                                get('farmbusinessresilience_farmincome_otherag_af')+
                                get('farmbusinessresilience_farmincome_othernag_af')+
                                incomeCalc(get('initialdata_seedsfeeds_arablestrawexport'),get('initialdata_seedsfeeds_arablestrawexportprice'),get('initialdata_seedsfeeds_arablestrawexportaf'))+
                                arrayCalc(get('initialdata_seedsfeeds_feedsexport'), get('initialdata_seedsfeeds_feedsexportprice'), get('initialdata_seedsfeeds_feedsexportaf'))+
                                multiply(get('initialdata_woodland_affuelexported'), get('initialdata_woodland_affuelprice'))+
                                multiply(get('initialdata_woodland_aftimberexported'), get('initialdata_woodland_aftimberprice'))+
                                multiply(get('initialdata_woodland_hedgefuelexport'), get('initialdata_woodland_hedgefuelprice'))+   
                                arraybinaryCalc(get('initialdata_crops_cropyieldexport'), get('initialdata_crops_cropprice'), get('initialdata_crops_isaf'))
                            },
                            farmbusinessresilience_financialsum_income_nafc: function() {
                                ...
                                get('farmbusinessresilience_farmincome_other_naf')+
                                get('farmbusinessresilience_farmincome_grants_naf')+
                                get('farmbusinessresilience_farmincome_otherag_naf')+
                                get('farmbusinessresilience_farmincome_othernag_naf')+
                                nincomeCalc(get('initialdata_seedsfeeds_arablestrawexport'),get('initialdata_seedsfeeds_arablestrawexportprice'),get('initialdata_seedsfeeds_arablestrawexportaf'))+
                                narrayCalc(get('initialdata_seedsfeeds_feedsexport'), get('initialdata_seedsfeeds_feedsexportprice'), get('initialdata_seedsfeeds_feedsexportaf'))+
                                multiply(get('initialdata_woodland_nonaffuelexported'), get('initialdata_woodland_nonaffuelprice'))+
                                multiply(get('initialdata_woodland_nonaftimberexported'), get('initialdata_woodland_nonaftimberprice'))+
                                narraybinaryCalc(get('initialdata_crops_cropyieldexport'), get('initialdata_crops_cropprice'), get('initialdata_crops_isaf'))
                            },
                            farmbusinessresilience_financialsum_income_livestock: function() {
                                return multiply(get('initialdata_fertilisers_organicexport'), get('initialdata_fertilisers_organicexportprice'))+
                                multiply(get('initialdata_livestock_productexport'), get('initialdata_livestock_productexportprice'))+
                                multiply(get('initialdata_livestock_export'), get('initialdata_livestock_exportprice'))
                            },
                            farmbusinessresilience_financialsum_income_other: function() {
                                return get('farmbusinessresilience_farmincome_decoupled_total')+
                                get('farmbusinessresilience_farmincome_agprac_total')+
                                get('farmbusinessresilience_farmincome_coupled_total')+
                                get('farmbusinessresilience_farmincome_ruraldev_total')+
                                get('farmbusinessresilience_farmincome_other_total')+
                                get('farmbusinessresilience_farmincome_grants_total')+
                                get('farmbusinessresilience_farmincome_otherag_total')+
                                get('farmbusinessresilience_farmincome_othernag_total')
                            },
                            farmbusinessresilience_financialsum_variable_afc: function() {
                                return get('initialdata_treecosts_affn_pruning')+
                                get('initialdata_treecosts_affw_pruning')+
                                get('initialdata_treecosts_aft_pruning')+
                                get('initialdata_treecosts_affn_fert')+
                                get('initialdata_treecosts_affw_fert')+
                                get('initialdata_treecosts_aft_fert')+
                                get('initialdata_treecosts_affn_understory')+
                                get('initialdata_treecosts_affw_understory')+
                                get('initialdata_treecosts_aft_understory')+
                                get('initialdata_treecosts_affn_harvesting')+
                                get('initialdata_treecosts_affw_harvesting')+
                                get('initialdata_treecosts_aft_harvesting')+
                                get('initialdata_treecosts_affn_grading')+
                                get('initialdata_treecosts_affw_grading')+
                                get('initialdata_treecosts_aft_grading')+
                                get('initialdata_treecosts_affn_packaging')+
                                get('initialdata_treecosts_affw_packaging')+
                                get('initialdata_treecosts_aft_packaging')+
                                get('initialdata_treecosts_affn_special')+
                                get('initialdata_treecosts_affw_special')+
                                get('initialdata_treecosts_aft_special')+
                                get('initialdata_treecosts_affn_standard')+
                                get('initialdata_treecosts_affw_standard')+
                                get('initialdata_treecosts_aft_standard')+
                                get('initialdata_treecosts_affn_fuel')+
                                get('initialdata_treecosts_affw_fuel')+
                                get('initialdata_treecosts_aft_fuel')+
                                get('initialdata_treecosts_affn_other')+
                                get('initialdata_treecosts_affw_other')+
                                get('initialdata_treecosts_aft_other')+
                                multiplyPerc(get('initialdata_cropcosts_arable_protection'), get('initialdata_cropcosts_arable_afprot'))+
                                multiplyPerc(get('initialdata_cropcosts_hort_protection'), get('initialdata_cropcosts_hort_afprot'))+
                                multiplyPerc(get('initialdata_cropcosts_fruit_protection'), get('initialdata_cropcosts_fruit_afprot'))+
                                multiplyPerc(get('initialdata_cropcosts_nonfood_protection'), get('initialdata_cropcosts_nonfood_afprot'))+
                                multiplyPerc(get('initialdata_cropcosts_forage_protection'), get('initialdata_cropcosts_forage_afprot'))+
                                incomeCalc(get('initialdata_fertilisers_inorganicimport'),get('initialdata_fertilisers_inorganicimportprice'), get('initialdata_fertilisers_inorganicimportaf'))+
                                incomeCalc(get('initialdata_fertilisers_organicimport'), get('initialdata_fertilisers_organicimportprice'), get('initialdata_fertilisers_organicimportaf'))+
                                incomeCalc(get('initialdata_seedsfeeds_seedsimport'), get('initialdata_seedsfeeds_seedsimportprice'), get('initialdata_seedsfeeds_seedsexportaf'))
                            },
                            farmbusinessresilience_financialsum_variable_nafc: function() {
                                return get('initialdata_treecosts_naffn_pruning')+
                                get('initialdata_treecosts_naffw_pruning')+
                                get('initialdata_treecosts_naft_pruning')+
                                get('initialdata_treecosts_naffn_fert')+
                                get('initialdata_treecosts_naffw_fert')+
                                get('initialdata_treecosts_naft_fert')+
                                get('initialdata_treecosts_naffn_understory')+
                                get('initialdata_treecosts_naffw_understory')+
                                get('initialdata_treecosts_naft_understory')+
                                get('initialdata_treecosts_naffn_harvesting')+
                                get('initialdata_treecosts_naffw_harvesting')+
                                get('initialdata_treecosts_naft_harvesting')+
                                get('initialdata_treecosts_naffn_grading')+
                                get('initialdata_treecosts_naffw_grading')+
                                get('initialdata_treecosts_naft_grading')+
                                get('initialdata_treecosts_naffn_packaging')+
                                get('initialdata_treecosts_naffw_packaging')+
                                get('initialdata_treecosts_naft_packaging')+
                                get('initialdata_treecosts_naffn_special')+
                                get('initialdata_treecosts_naffw_special')+
                                get('initialdata_treecosts_naft_special')+
                                get('initialdata_treecosts_naffn_standard')+
                                get('initialdata_treecosts_naffw_standard')+
                                get('initialdata_treecosts_naft_standard')+
                                get('initialdata_treecosts_naffn_fuel')+
                                get('initialdata_treecosts_naffw_fuel')+
                                get('initialdata_treecosts_naft_fuel')+
                                get('initialdata_treecosts_naffn_other')+
                                get('initialdata_treecosts_naffw_other')+
                                get('initialdata_treecosts_naft_other')+
                                nmultiplyPerc(get('initialdata_cropcosts_arable_protection'), get('initialdata_cropcosts_arable_afprot'))+
                                nmultiplyPerc(get('initialdata_cropcosts_hort_protection'), get('initialdata_cropcosts_hort_afprot'))+
                                nmultiplyPerc(get('initialdata_cropcosts_fruit_protection'), get('initialdata_cropcosts_fruit_afprot'))+
                                nmultiplyPerc(get('initialdata_cropcosts_nonfood_protection'), get('initialdata_cropcosts_nonfood_afprot'))+
                                nmultiplyPerc(get('initialdata_cropcosts_forage_protection'), get('initialdata_cropcosts_forage_afprot'))+
                                nincomeCalc(get('initialdata_fertilisers_inorganicimport'),get('initialdata_fertilisers_inorganicimportprice'), get('initialdata_fertilisers_inorganicimportaf'))+
                                nincomeCalc(get('initialdata_fertilisers_organicimport'), get('initialdata_fertilisers_organicimportprice'), get('initialdata_fertilisers_organicimportaf'))+
                                nincomeCalc(get('initialdata_seedsfeeds_seedsimport'), get('initialdata_seedsfeeds_seedsimportprice'), get('initialdata_seedsfeeds_seedsexportaf'))
                            },
                            farmbusinessresilience_financialsum_variable_livestock: function() {
                                return get('initialdata_treecosts_naffn_pruning')+
                                get('initialdata_livestockcosts_dairy_special')+
                                get('initialdata_livestockcosts_beef_special')+
                                get('initialdata_livestockcosts_sheep_special')+
                                get('initialdata_livestockcosts_pigs_special')+
                                get('initialdata_livestockcosts_chickens_special')+
                                get('initialdata_livestockcosts_turkey_special')+
                                get('initialdata_livestockcosts_ducks_special')+
                                get('initialdata_livestockcosts_horses_special')+
                                get('initialdata_livestockcosts_other_special')+
                                get('initialdata_livestockcosts_dairy_standard')+
                                get('initialdata_livestockcosts_beef_standard')+
                                get('initialdata_livestockcosts_sheep_standard')+
                                get('initialdata_livestockcosts_pigs_standard')+
                                get('initialdata_livestockcosts_chickens_standard')+
                                get('initialdata_livestockcosts_turkey_standard')+
                                get('initialdata_livestockcosts_ducks_standard')+
                                get('initialdata_livestockcosts_horses_standard')+
                                get('initialdata_livestockcosts_other_standard')+
                                get('initialdata_livestockcosts_dairy_vet')+
                                get('initialdata_livestockcosts_beef_vet')+
                                get('initialdata_livestockcosts_sheep_vet')+
                                get('initialdata_livestockcosts_pigs_vet')+
                                get('initialdata_livestockcosts_chickens_vet')+
                                get('initialdata_livestockcosts_turkey_vet')+
                                get('initialdata_livestockcosts_ducks_vet')+
                                get('initialdata_livestockcosts_horses_vet')+
                                get('initialdata_livestockcosts_other_vet')+
                                get('initialdata_livestockcosts_dairy_bedding')+
                                get('initialdata_livestockcosts_beef_bedding')+
                                get('initialdata_livestockcosts_sheep_bedding')+
                                get('initialdata_livestockcosts_pigs_bedding')+
                                get('initialdata_livestockcosts_chickens_bedding')+
                                get('initialdata_livestockcosts_turkey_bedding')+
                                get('initialdata_livestockcosts_ducks_bedding')+
                                get('initialdata_livestockcosts_horses_bedding')+
                                get('initialdata_livestockcosts_other_bedding')+
                                get('initialdata_livestockcosts_dairy_other')+
                                get('initialdata_livestockcosts_beef_other')+
                                get('initialdata_livestockcosts_sheep_other')+
                                get('initialdata_livestockcosts_pigs_other')+
                                get('initialdata_livestockcosts_chickens_other')+
                                get('initialdata_livestockcosts_turkey_other')+
                                get('initialdata_livestockcosts_ducks_other')+
                                get('initialdata_livestockcosts_horses_other')+
                                get('initialdata_livestockcosts_other_other')+
                                get('initialdata_livestockcosts_dairy_paid')+
                                get('initialdata_livestockcosts_beef_paid')+
                                get('initialdata_livestockcosts_sheep_paid')+
                                get('initialdata_livestockcosts_pigs_paid')+
                                get('initialdata_livestockcosts_chickens_paid')+
                                get('initialdata_livestockcosts_turkey_paid')+
                                get('initialdata_livestockcosts_ducks_paid')+
                                get('initialdata_livestockcosts_horses_paid')+
                                get('initialdata_livestockcosts_other_paid')+
                                multiply(get('initialdata_seedsfeeds_arablestrawimport'), get('initialdata_seedsfeeds_arablestrawimportprice'))+
                                multiply(get('initialdata_seedsfeeds_feedsimport'), get('initialdata_seedsfeeds_feedsimportprice'))+
                                multiply(get('initialdata_livestock_import'), get('initialdata_livestock_importprice'))+
                                multiply(get('initialdata_livestock_productimport'), get('initialdata_livestock_productimportprice'))
                            },
                            farmbusinessresilience_financialsum_variable_other: function() {
                                return get('initialdata_cropcosts_arable_special')+
                                    get('initialdata_cropcosts_hort_special')+
                                    get('initialdata_cropcosts_fruit_special')+
                                    get('initialdata_cropcosts_nonfood_special')+
                                    get('initialdata_cropcosts_forage_special')+
                                    get('initialdata_cropcosts_arable_standard')+
                                    get('initialdata_cropcosts_hort_standard')+
                                    get('initialdata_cropcosts_fruit_standard')+
                                    get('initialdata_cropcosts_nonfood_standard')+
                                    get('initialdata_cropcosts_forage_standard')+
                                    get('initialdata_cropcosts_arable_seedtreat')+
                                    get('initialdata_cropcosts_hort_seedtreat')+
                                    get('initialdata_cropcosts_fruit_seedtreat')+
                                    get('initialdata_cropcosts_nonfood_seedtreat')+
                                    get('initialdata_cropcosts_forage_seedtreat')+
                                    get('initialdata_cropcosts_arable_fuel')+
                                    get('initialdata_cropcosts_hort_fuel')+
                                    get('initialdata_cropcosts_fruit_fuel')+
                                    get('initialdata_cropcosts_nonfood_fuel')+
                                    get('initialdata_cropcosts_forage_fuel')+
                                    get('initialdata_cropcosts_arable_other')+
                                    get('initialdata_cropcosts_hort_other')+
                                    get('initialdata_cropcosts_fruit_other')+
                                    get('initialdata_cropcosts_nonfood_other')+
                                    get('initialdata_cropcosts_forage_other')+
                                    get('initialdata_cropcosts_arable_paid')+
                                    get('initialdata_cropcosts_hort_paid')+
                                    get('initialdata_cropcosts_fruit_paid')+
                                    get('initialdata_cropcosts_nonfood_paid')+
                                    get('initialdata_cropcosts_forage_paid')
                            },
                            farmbusinessresilience_financialsum_gross_afc: function() {
                                return get('farmbusinessresilience_financialsum_income_afc')-
                                get('farmbusinessresilience_financialsum_variable_afc')
                            },
                            farmbusinessresilience_financialsum_gross_nafc: function() {
                                return get('farmbusinessresilience_financialsum_income_nafc')-
                                get('farmbusinessresilience_financialsum_variable_nafc')
                            },
                            farmbusinessresilience_financialsum_gross_livestock: function() {
                                return get('farmbusinessresilience_financialsum_income_livestock')-
                                get('farmbusinessresilience_financialsum_variable_livestock')
                            },
                            farmbusinessresilience_financialsum_gross_other: function() {
                                return get('farmbusinessresilience_financialsum_income_other')-
                                get('farmbusinessresilience_financialsum_variable_other')
                            },
                            farmbusinessresilience_financialsum_fixed_total: function() {
                                return get('farmbusinessresilience_othercosts_upkeep')+
                                    get('farmbusinessresilience_othercosts_specific')+
                                    get('farmbusinessresilience_othercosts_overheads')+
                                    get('farmbusinessresilience_othercosts_rent')+
                                    get('farmbusinessresilience_othercosts_depreciation')+
                                    get('farmbusinessresilience_othercosts_assets')+
                                    get('farmbusinessresilience_othercosts_liabilities')
                            }
                        }
                    }
                }
